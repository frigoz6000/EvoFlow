      ...
      <div className="kpi-row">
        ...
        <ErrorBoundary fallback={<div className="kpi-card">—</div>}>
          <KpiCard
            ...
            accent={ORANGE}
            icon={<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="3" y="3" width="12" height="18" rx="1"/><rect x="5" y="7" width="7" height="5" rx="1"/><path d="M15 8h3a1 1 0 0 1 1 1v4a1 1 0 0 1-1 1h-3"/></svg>}
          />
        </ErrorBoundary>
        <ErrorBoundary fallback={<div className="kpi-card">—</div>}>
          <KpiCard
