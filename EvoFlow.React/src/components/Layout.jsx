...
const NAV_DEF = [
  ...
  { to: '/volume-discrepancies', icon: IconShieldCheck, labelKey: 'nav_volume_discrepancies' },
  { to: '/sudden-loss', icon: IconAlertTriangle, labelKey: 'nav_sudden_loss' },
  { to: '/system-events', icon: IconClipboardList, labelKey: 'nav_system_events' },
...
const PAGE_TITLE_KEYS = {
  ...
  '/volume-discrepancies': 'nav_volume_discrepancies',
  '/system-events': 'nav_system_events',
  '/sudden-loss': 'nav_sudden_loss',
